            ...
            if (n >= 3) {
                ...
                for (int i = 0; i < 1; i++) {
                    ...
                    try (BufferedReader reader = new BufferedReader(
                            new FileReader("D:\\Java programs\\my first project\\src\\Dashboard\\user_data.csv"))) {
                        String line;
                ...
                String file1 = "D:\\Java programs\\my first project\\src\\Dashboard\\" + s1 + "_cart_file" + ".csv";
                // String
                // file2="C:\\Users\\aagam\\OneDrive\\Desktop\\Javaproject\\myfirstproject\\src\\Dashboard\\"+s1+"_order_file"+".csv";
                String file2 = "D:\\Java programs\\my first project\\src\\Dashboard\\" + s1 + "_order_file" + ".csv";
                try (BufferedWriter writer = new BufferedWriter(
                        new FileWriter("D:\\Java programs\\my first project\\src\\Dashboard\\user_data.csv", true))) {
                    writer.write("\n" + name + "," + email + "," + password);
                    System.out.println();
