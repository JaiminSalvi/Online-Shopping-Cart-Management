...
class watch extends Cart_adding {
    @Override
    public void add_cart(int id, String q, String name) {
        int ct = 1;
        String naam = "", pr = "";
        try (BufferedReader reader = new BufferedReader(new FileReader(
                "D:\\Java programs\\my first project\\src\\Dashboard\\Watch_item.csv"))) {
            String line;
    ...
    public static void main(String args) {
        ...
        try (BufferedReader reader = new BufferedReader(
                new FileReader("D:\\Java programs\\my first project\\src\\Dashboard\\Watch_item.csv"))) {
            String line;
            while ((line = reader.readLine()) != null) {
