...
class GPay extends payment {
    ...
    public float get_total(String args) {
        ...
        String file1 = "D:\\Java programs\\my first project\\src\\Dashboard\\" + args + "_cart_file" + ".csv";
        float final1 = 0;
...
public class random {
    public static void main(String args) {
        ...
        float cost = 0;
        String file1 = "D:\\Java programs\\my first project\\src\\Dashboard\\" + args + "_order_file" + ".csv";
        String file2 = "D:\\Java programs\\my first project\\src\\Dashboard\\" + args + "_cart_file" + ".csv";
